...
private:
	std::vector<std::pair<std::string_view, bool>> input_test_p1 = {
		std::make_pair("aeixx", true),
		std::make_pair("aeixxab", false),
		std::make_pair("ugknbfddgicrmopn", true),
		std::make_pair("aaa", true),
		std::make_pair("jchzalrnumimnmhp", false),
		std::make_pair("haegwjzuvuyypxyu", false),
		std::make_pair("dvszwmarrgswjxmb", false)};

	std::vector<std::pair<std::string_view, bool>> input_test_p2 = {
		std::make_pair("aaaa", true),
		std::make_pair("xyxy", true),
		std::make_pair("aaa", false),
		std::make_pair("aaabab", true),
		std::make_pair("xxyxx", true),
		std::make_pair("uurcxstgmygtbstg", false),
		std::make_pair("ieodomkazucvgmuy", false)};
